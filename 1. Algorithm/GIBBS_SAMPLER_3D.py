...
def gibbs_sampler_2_gaussians(
    ...
    tsne_1 = window_3d.tsne_1
    tsne_2 = window_3d.tsne_2
    ...
    mean.columns = ["Pseudo_Time_normal", "tsne_1", "tsne_2"]
    ...
    df_M1_mu_sample_array_1 = pd.DataFrame(
        ...
        columns=["Pseudo_Time_normal", "tsne_1", "tsne_2"],
        dtype="float64",
    )
    ...
    M2_df_mu_samples_G1 = pd.DataFrame(
        M2_mu_sample_array_G1[1:], columns=["Pseudo_Time_normal", "tsne_1", "tsne_2"]
    )
    M2_df_mu_samples_G2 = pd.DataFrame(
        M2_mu_sample_array_G2[1:], columns=["Pseudo_Time_normal", "tsne_1", "tsne_2"]
    )
    ...
    if bayes_factor_12 >= 0:
        ...
        d = {
            ...
            "G1_tsne_1": ORIGINAL_window_1["tsne_1"],
            "G1_tsne_2": ORIGINAL_window_1["tsne_2"],
        }
        ...
        d = {
            ...
            "G1_tsne_1": window_3d["tsne_1"],
            "G1_tsne_2": window_3d["tsne_2"],
        }
        ...
        #     ax.scatter( M2_df_G1_post.Pseudo_Time_normal, M2_df_G1_post.tsne_1,  M2_df_G1_post.tsne_2, c='b', marker='1', s = 20)
        #     ax.scatter( M2_df_G2_post.Pseudo_Time_normal, M2_df_G2_post.tsne_1,  M2_df_G2_post.tsne_2, c='k', marker='1', s = 20)
        #     ax.scatter( wp_data_TSNE_ROW.Pseudo_Time_normal, wp_data_TSNE_ROW.tsne_1,  wp_data_TSNE_ROW.tsne_2, c='r', marker='o', s = 40)
        ...
        mean_G1.columns = ["Pseudo_Time_normal", "tsne_1", "tsne_2"]

        mean_G2 = M2_df_G2_post.mean(axis=0)
        mean_G2.columns = ["Pseudo_Time_normal", "tsne_1", "tsne_2"]
        ...
        if false_positive_FLAG == True:
            ...
            if len(ORIGINAL_window_1["Pseudo_Time_normal"]) > len(
                ...
                d = {
                    ...
                    "G2_tsne_1": ORIGINAL_window_2["tsne_1"],
                    "G2_tsne_2": ORIGINAL_window_2["tsne_2"],
                }
                data_output_gibbs_ORIGNAL = pd.DataFrame(d)
                ...
                d = {
                    ...
                    "G1_tsne_1": PROJECTED_window_1["tsne_1"],
                    "G1_tsne_2": PROJECTED_window_1["tsne_2"],
                    "G2_Pseudo_Time_normal": PROJECTED_window_2["Pseudo_Time_normal"],
                    "G2_tsne_1": PROJECTED_window_2["tsne_1"],
                    "G2_tsne_2": PROJECTED_window_2["tsne_2"],
                }
                data_output_gibbs_PROJECTED = pd.DataFrame(d)
                ...
                d = {
                    ...
                    "G1_tsne_1": ORIGINAL_window_2["tsne_1"],
                    "G1_tsne_2": ORIGINAL_window_2["tsne_2"],
                    "G2_Pseudo_Time_normal": ORIGINAL_window_1["Pseudo_Time_normal"],
                    "G2_tsne_1": ORIGINAL_window_1["tsne_1"],
                    "G2_tsne_2": ORIGINAL_window_1["tsne_2"],
                }
                data_output_gibbs_ORIGNAL = pd.DataFrame(d)
                ...
                d = {
                    ...
                    "G1_tsne_1": PROJECTED_window_2["tsne_1"],
                    "G1_tsne_2": PROJECTED_window_2["tsne_2"],
                    "G2_Pseudo_Time_normal": PROJECTED_window_1["Pseudo_Time_normal"],
                    "G2_tsne_1": PROJECTED_window_1["tsne_1"],
                    "G2_tsne_2": PROJECTED_window_1["tsne_2"],
                }
                data_output_gibbs_PROJECTED = pd.DataFrame(d)
